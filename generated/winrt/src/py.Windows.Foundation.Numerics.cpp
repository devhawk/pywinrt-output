...
winrt::Windows::Foundation::Numerics::float3x2 py::converter<winrt::Windows::Foundation::Numerics::float3x2>::convert_to(PyObject* obj)
{
    ...
    py::pyobj_handle py_M11{ PyDict_GetItemString(obj, "m11") };
    if (!py_M11) { throw winrt::hresult_invalid_argument(); }
    return_value.m11 = converter<float>::convert_to(py_M11.get());
    
    py::pyobj_handle py_M12{ PyDict_GetItemString(obj, "m12") };
    if (!py_M12) { throw winrt::hresult_invalid_argument(); }
    return_value.m12 = converter<float>::convert_to(py_M12.get());
    
    py::pyobj_handle py_M21{ PyDict_GetItemString(obj, "m21") };
    if (!py_M21) { throw winrt::hresult_invalid_argument(); }
    return_value.m21 = converter<float>::convert_to(py_M21.get());
    
    py::pyobj_handle py_M22{ PyDict_GetItemString(obj, "m22") };
    if (!py_M22) { throw winrt::hresult_invalid_argument(); }
    return_value.m22 = converter<float>::convert_to(py_M22.get());
    
    py::pyobj_handle py_M31{ PyDict_GetItemString(obj, "m31") };
    if (!py_M31) { throw winrt::hresult_invalid_argument(); }
    return_value.m31 = converter<float>::convert_to(py_M31.get());
    
    py::pyobj_handle py_M32{ PyDict_GetItemString(obj, "m32") };
    if (!py_M32) { throw winrt::hresult_invalid_argument(); }
    return_value.m32 = converter<float>::convert_to(py_M32.get());
...
winrt::Windows::Foundation::Numerics::float4x4 py::converter<winrt::Windows::Foundation::Numerics::float4x4>::convert_to(PyObject* obj)
{
    ...
    py::pyobj_handle py_M13{ PyDict_GetItemString(obj, "m13") };
    if (!py_M13) { throw winrt::hresult_invalid_argument(); }
    return_value.m13 = converter<float>::convert_to(py_M13.get());
    
    py::pyobj_handle py_M14{ PyDict_GetItemString(obj, "m14") };
    if (!py_M14) { throw winrt::hresult_invalid_argument(); }
    return_value.m14 = converter<float>::convert_to(py_M14.get());
    ...
    py::pyobj_handle py_M23{ PyDict_GetItemString(obj, "m23") };
    if (!py_M23) { throw winrt::hresult_invalid_argument(); }
    return_value.m23 = converter<float>::convert_to(py_M23.get());
    
    py::pyobj_handle py_M24{ PyDict_GetItemString(obj, "m24") };
    if (!py_M24) { throw winrt::hresult_invalid_argument(); }
    return_value.m24 = converter<float>::convert_to(py_M24.get());
    ...
    py::pyobj_handle py_M33{ PyDict_GetItemString(obj, "m33") };
    if (!py_M33) { throw winrt::hresult_invalid_argument(); }
    return_value.m33 = converter<float>::convert_to(py_M33.get());
    
    py::pyobj_handle py_M34{ PyDict_GetItemString(obj, "m34") };
    if (!py_M34) { throw winrt::hresult_invalid_argument(); }
    return_value.m34 = converter<float>::convert_to(py_M34.get());
    
    py::pyobj_handle py_M41{ PyDict_GetItemString(obj, "m41") };
    if (!py_M41) { throw winrt::hresult_invalid_argument(); }
    return_value.m41 = converter<float>::convert_to(py_M41.get());
    
    py::pyobj_handle py_M42{ PyDict_GetItemString(obj, "m42") };
    if (!py_M42) { throw winrt::hresult_invalid_argument(); }
    return_value.m42 = converter<float>::convert_to(py_M42.get());
    
    py::pyobj_handle py_M43{ PyDict_GetItemString(obj, "m43") };
    if (!py_M43) { throw winrt::hresult_invalid_argument(); }
    return_value.m43 = converter<float>::convert_to(py_M43.get());
    
    py::pyobj_handle py_M44{ PyDict_GetItemString(obj, "m44") };
    if (!py_M44) { throw winrt::hresult_invalid_argument(); }
    return_value.m44 = converter<float>::convert_to(py_M44.get());
...
winrt::Windows::Foundation::Numerics::plane py::converter<winrt::Windows::Foundation::Numerics::plane>::convert_to(PyObject* obj)
{
    ...
    py::pyobj_handle py_Normal{ PyDict_GetItemString(obj, "normal") };
    if (!py_Normal) { throw winrt::hresult_invalid_argument(); }
    return_value.normal = converter<winrt::Windows::Foundation::Numerics::float3>::convert_to(py_Normal.get());
    
    py::pyobj_handle py_D{ PyDict_GetItemString(obj, "d") };
    if (!py_D) { throw winrt::hresult_invalid_argument(); }
    return_value.d = converter<float>::convert_to(py_D.get());
...
PyObject* _new_Plane(PyTypeObject* type, PyObject* args, PyObject* kwds)
{
    ...
    py::pyobj_handle _Normal{};
    float _D{};
    
    static const char* kwlist[] = {"normal", "d", nullptr};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "Of", const_cast<char**>(kwlist), _Normal.put(), &_D))
    {
        return nullptr;
    }
...
winrt::Windows::Foundation::Numerics::quaternion py::converter<winrt::Windows::Foundation::Numerics::quaternion>::convert_to(PyObject* obj)
{
    ...
    py::pyobj_handle py_Z{ PyDict_GetItemString(obj, "z") };
    if (!py_Z) { throw winrt::hresult_invalid_argument(); }
    return_value.z = converter<float>::convert_to(py_Z.get());
    
    py::pyobj_handle py_W{ PyDict_GetItemString(obj, "w") };
    if (!py_W) { throw winrt::hresult_invalid_argument(); }
    return_value.w = converter<float>::convert_to(py_W.get());
...
winrt::Windows::Foundation::Numerics::Rational py::converter<winrt::Windows::Foundation::Numerics::Rational>::convert_to(PyObject* obj)
{
    ...
    py::pyobj_handle py_Numerator{ PyDict_GetItemString(obj, "numerator") };
    if (!py_Numerator) { throw winrt::hresult_invalid_argument(); }
    return_value.Numerator = converter<uint32_t>::convert_to(py_Numerator.get());
    
    py::pyobj_handle py_Denominator{ PyDict_GetItemString(obj, "denominator") };
    if (!py_Denominator) { throw winrt::hresult_invalid_argument(); }
    return_value.Denominator = converter<uint32_t>::convert_to(py_Denominator.get());
