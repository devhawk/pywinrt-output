...
static PyObject* IDirect3DDevice__from(PyObject* /*unused*/, PyObject* arg)
{
    try
    {
        ...
        return py::converter<winrt::Windows::Graphics::DirectX::Direct3D11::IDirect3DDevice>::convert(instance.as<winrt::Windows::Graphics::DirectX::Direct3D11::IDirect3DDevice>());
    }
    catch (...)
    {
        return py::to_PyErr();
...
static PyObject* IDirect3DSurface__from(PyObject* /*unused*/, PyObject* arg)
{
    ...
    {
        auto instance = py::converter<winrt::Windows::Foundation::IInspectable>::convert_to(arg);
        return py::converter<winrt::Windows::Graphics::DirectX::Direct3D11::IDirect3DSurface>::convert(instance.as<winrt::Windows::Graphics::DirectX::Direct3D11::IDirect3DSurface>());
    }
    catch (...)
    {
        return py::to_PyErr();
...
static PyObject* Direct3DMultisampleDescription_get_Quality(py::winrt_struct_wrapper<winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DMultisampleDescription>* self, void* /*unused*/)
{
    try
    {
        return py::converter<decltype(self->obj.Quality)>::convert(self->obj.Quality);
    }
    catch (...)
    {
        return py::to_PyErr();
...
static PyObject* Direct3DSurfaceDescription_get_Format(py::winrt_struct_wrapper<winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DSurfaceDescription>* self, void* /*unused*/)
{
    try
    {
        return py::converter<decltype(self->obj.Format)>::convert(self->obj.Format);
    }
    catch (...)
    {
        return py::to_PyErr();
...
static PyObject* Direct3DSurfaceDescription_get_MultisampleDescription(py::winrt_struct_wrapper<winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DSurfaceDescription>* self, void* /*unused*/)
{
    try
    {
        return py::converter<decltype(self->obj.MultisampleDescription)>::convert(self->obj.MultisampleDescription);
    }
    catch (...)
    {
        return py::to_PyErr();
